...
describe("OIDCSettings", () => {
    ...
    it("reports a rejected configuration without claiming it was saved", async () => {
        updateSettings.mockRejectedValueOnce(new Error("issuer for OIDC is invalid"));
        const user = userEvent.setup();
        render(<OIDCSettings />);
        ...
        await waitFor(() => expect(toast).toHaveBeenCalledWith(expect.objectContaining({
            ...
            description: "issuer for OIDC is invalid",
            variant: "destructive",
        })));
        expect(toast).not.toHaveBeenCalledWith(expect.objectContaining({ title: "OIDC settings saved" }));
