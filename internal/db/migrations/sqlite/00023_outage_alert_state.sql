...
ALTER TABLE monitor_outages ADD COLUMN notified_at TIMESTAMP;
ALTER TABLE monitor_outages ADD COLUMN last_reminder_at TIMESTAMP;
...
ALTER TABLE monitor_outages DROP COLUMN last_reminder_at;
ALTER TABLE monitor_outages DROP COLUMN notified_at;
