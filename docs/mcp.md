...
See [Adaptive Latency Baselines](adaptive-latency.md) for the formula, learning period, threshold precedence, and guidance for migrations between networks or regions.
